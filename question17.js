"use strict";
let lsitOfGuest = ["laiba", "fatima", "meryam", "areeba", "kinza", "aneela", "mubashra", "werda"];
...
const notComming = lsitOfGuest[1];
console.log(`\nUnfortunately, ${notComming} can't make it to dinner.\n`);
const newwGest = "Laiba";
...
while (lsitOfGuest.length > 2) {
    const removedGuest = lsitOfGuest.pop();
